<template>
  <div class="container">
    ...
    <ul class="category list-unstyled d-flex justify-content-center my-5">
      <li class="btn btn-outline-primary mx-1 py-1 px-4">全部</li>
      <li class="btn btn-outline-primary mx-1 py-1 px-4">麵包</li>
      <li class="btn btn-outline-primary mx-1 py-1 px-4">蛋糕</li>
      <li class="btn btn-outline-primary mx-1 py-1 px-4">餅乾</li>
    </ul>
    <ul class="products row g-3 p-0 mt-5">
      ...
      >
        ...
        <div class="products-body p-3">
          <p class="products-title m-0" role="button"
            @click="goToProduct(item.id)"
            >{{ item.title }}</p>
